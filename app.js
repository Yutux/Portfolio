...
.pauseFor(1800)
.changeDelay(20)
.typeString('<strong style="font-family:pix; color: white;"> Moi c\'est Zogoury David, Développeur</strong>')
.pauseFor(300)
.typeString('<strong style="font-family:pix; color: #27ae60;"> Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)
