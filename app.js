...
.pauseFor(1800)
.changeDelay(20)
.typeString('<strong style="font-family:pix; color: white;"> Moi c\'est Zogoury David </strong>')
.pauseFor(300)
.typeString('<strong style="font-family:pix; color: white">, Développeur Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #27ae60; font-family:pix;"> CSS</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #EA39ff; font-family:pix;"> PhP</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: red; font-family:pix;"> React</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: coral; font-family:pix;"> C#</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: Yellow; font-family:pix;"> Java</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #ff6910; font-family:pix;"> JavaScript</span> !')
.start()
